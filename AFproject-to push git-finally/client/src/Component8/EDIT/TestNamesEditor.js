...
class TestNamesEditor extends Component{
    ...
    onSubmit(event){
        event.preventDefault();
        event.stopPropagation();
        fetch('http://localhost:8084/test/'+this._id, {
            method:'GET',
    ...
    render() {
        return (
            < div id = "wrapper" >
                ...
                <div>
                    <a className="dropdown-toggle" data-toggle="dropdown" href="http://localhost:3000/testnames"><button type="submit" className="btn btn-default" >Back</button></a>
