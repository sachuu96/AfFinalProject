...
class Tr extends Component {
  ...
  static get propTypes() {
    ...
    delete(id) {
        axios.delete('http://localhost:8081/labs' + '/' + id).then(results => {
...
render(){
    return (
      <tr>
        <td>
          <a href="http://localhost:3000/labs/add_sample_details">Add Specimen Details</a><br/>
          <a href="http://localhost:3000/labs/add_test_results_p_details">Add Test Results and Patient Details</a><br/>
          <a href="http://localhost:3000/labs/MyReport">View Report</a><br/>
          <a href="http://localhost:3000/labs/view_sample_details">View Sample Details</a><br/>
        </td>
