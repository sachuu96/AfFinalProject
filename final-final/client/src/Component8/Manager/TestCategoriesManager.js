...
class TestCategoriesManager extends Component{
    ...
    addCategory(categoryname,subcategoryname,specimentype,specimen_Retention_Type,duration){
        if(categoryname =='' | subcategoryname=='' | specimentype=='' | specimen_Retention_Type=='' | duration==''){
            ...
            var data = {
                ...
                "specimen_Retention_Type": specimen_Retention_Type,
                "duration": duration
            };
            console.log(data);
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <form role="form">
                                                    ...
                                                    <a className="dropdown-toggle" data-toggle="dropdown" href="http://localhost:3000/testcategories"><button type="button" className="btn btn-default" >Back</button></a>
