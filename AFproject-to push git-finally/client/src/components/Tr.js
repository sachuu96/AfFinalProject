...
render(){
    return (
      <tr>
        <td>
          <a href="http://localhost:3000/labs/add_sample_details">Add Sample Details</a><br/>
          <a href="http://localhost:3000/labs/add_test_results_p_details">Add Test Results</a><br/>
          <a href="http://localhost:3000/labs/report">View Report</a><br/>
